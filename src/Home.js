...
class Home extends React.Component {
  ...
  render() {
    return (
      <div>
        <p>Jest to kopia strony <a href="https://uw-team.org/dekoder.html" target="_blank" title="uw-team dekoder">https://uw-team.org/dekoder.html</a> stworzona w celu nauki React</p>
