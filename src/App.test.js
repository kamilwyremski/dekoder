...
it("sprawdź losowe hasło", () => {
  ...
  const inputDlugosc = container.querySelector(
...
it("sprawdź base64", () => {
  ...
  expect(input.value).toBe("MTIzNA==");
...
it("sprawdź ROT", () => {
  ...
  const inputPrzesuniecie = container.querySelector(
...
it("sprawdź URLENCODE", () => {
  const input = container.querySelector("[name=input_urldecode]");
  const button = container.querySelector("#button_urlencode");

  expect(input.value).toBe("");

  input.value = "http://localhost:3000/ ze spacją";
  ReactTestUtils.Simulate.change(input);
  ReactTestUtils.Simulate.click(button);
  expect(input.value).toBe("http://localhost:3000/%20ze%20spacj%C4%85");
});
...
it("sprawdź URLDECODE", () => {
  ...
  input.value = "http://localhost:3000/%20ze%20spacj%C4%85";
  ReactTestUtils.Simulate.change(input);
  ReactTestUtils.Simulate.click(button);
  expect(input.value).toBe("http://localhost:3000/ ze spacją");
});
...
it("sprawdź Hex", () => {
  ...
  input.value = "0x74 0x65 0x73 0x74";
  ReactTestUtils.Simulate.change(input);
  ReactTestUtils.Simulate.click(button);
